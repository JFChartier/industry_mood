...
rf.multiclasses.model=ranger::ranger(dependent.variable.name = "label_of_class", data=data.classification.train[id.sub.train,], num.trees=500, num.threads=6, classification=T, importance="impurity")
