...
rf.bin.model=ranger::ranger(dependent.variable.name = "label_of_class", data=data.classification.train[id.sub.train,], num.trees=50000, num.threads=6, classification=T)
...
rf.multi.model.consul=ranger::ranger(dependent.variable.name = "label_of_class", data=data.classification.train.consul, num.trees=50000, num.threads=6, classification=T)
