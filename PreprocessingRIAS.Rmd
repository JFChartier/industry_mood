...
matrix.regcan=readRDS("wordfrequency.matrix.regcan.rds")
#unit vector norm
...
svd.from.irba.800=irlba::irlba(matrix.regcan.norm, 800, tol=1e-5)
#change colnames
svd.col.names=sapply(seq(1:length(svd.from.irba.800$d)), function(x) paste0("latent", x))
svd.from.irba.800$feature.names = svd.col.names

saveRDS(svd.from.irba.800, file = "svd.of.regcan.from.irba.800.rds")
