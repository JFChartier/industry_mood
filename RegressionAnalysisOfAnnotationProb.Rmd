...
huxtable::as_huxtable(sort(rf.bin.model$variable.importance, decreasing = T)%>%head(., n = 20), add_colnames=T, add_rownames=T)%>%huxtable::theme_basic(.)
...
huxtable::as_huxtable(sort(rf.institution.model$variable.importance, decreasing = T)%>%head(., n = 20), add_colnames=T, add_rownames=T)%>%huxtable::theme_basic(.)
```
...
huxtable::as_huxtable(sort(rf.advocacy.model$variable.importance, decreasing = T)%>%head(., n = 20), add_colnames=T, add_rownames=T)%>%huxtable::theme_basic(.)
```
...
huxtable::as_huxtable(sort(rf.industry.model$variable.importance, decreasing = T)%>%head(., n = 20), add_colnames=T, add_rownames=T)%>%huxtable::theme_basic(.)
```
